...
return ( <div className="group overflow-hidden rounded-2xl border border-stone-200 bg-white transition-all duration-300 hover:border-amber-300 hover:shadow-md">
      ...
      {badge && (
        <span
          className={`absolute left-3 top-3 rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide ${
            badgeStyles[badge] || "bg-stone-900 text-white"
          }`}
        >
          {badge}
        </span>
